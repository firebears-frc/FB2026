...
public class corrections{
    ...
    // Corrects the X for the location of a part of the bot given an offset between it and the center of the bot
    // Offsets are based on the offsets when the bot is at angle 0, following field rules for positive and negative.
    ...
    public static double correctAngleValue(double angleValue, double targetLocationX, double targetLocationY, Drive drive){
